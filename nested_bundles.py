...
class NavList(Bundleable):
    def __init__(self, nav_msg, nav_msg_list, int_list, str_list, **kwargs):
...
if __name__ == '__main__':
    ...
    nav_list = NavList(NavMessage(1, 1, 1, 1), nav_msg_list, [i for i in xrange(5)], [str(i) for i in xrange(5)])
